...
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "or-tools";
    rev = "v${version}";
    hash = "sha256-dhfireiXWeQpQM5chjNJ6+E9DxDVIHSo1/Xv58XLePE=";
  };
  # patches = [
  ...
  cmakeFlags = [
    ...
    "-DUSE_GLPK=ON"
    "-DUSE_SCIP=OFF"
    # TODO(breakds): HiGHS seems pretty useful. Currently it is blocked by
    # undefined reference to a log function.
    "-DUSE_HIGHS=OFF"
